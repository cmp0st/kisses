...
class PingRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PingRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'kisses.v1'), createEmptyInstance: create)
...
class PingResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PingResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'kisses.v1'), createEmptyInstance: create)
...
class KissesServiceApi {
  ...
  $async.Future<PingResponse> ping($pb.ClientContext? ctx, PingRequest request) =>
    _client.invoke<PingResponse>(ctx, 'KissesService', 'Ping', request, PingResponse())
  ;
}
